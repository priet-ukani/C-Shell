...
void flags_check(char* peek_to)
{
    ...
    if(strcmp(temp2_2, "-l")==0){ flag_l=true;  ignore_start+=3;}
    else if(strcmp(temp2_2, "-a")==0){ flag_a=true;  ignore_start+=3;}
    if(strcmp(temp3, "-la")==0){ flag_l=flag_a=true;  ignore_start+=3;}
    else if(strcmp(temp3, "-al")==0){ flag_l=flag_a=true;  ignore_start+=3;}
}
